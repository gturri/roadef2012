...
int64 SolutionChecker::GetObjectiveCost() const {
  ...
  cout << "load cost : " << load_cost << endl
      << "balance cost : " << balance_cost << endl
      << "process move cost : " << process_move_cost << endl
      << "service move cost : " << service_move_cost << endl
      << "machine move cost : " << machine_move_cost << endl
