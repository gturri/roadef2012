...
void ParseCmdLine::parseLine(variables_map& vm_p, const options_description& desc_p, int argc_p, char** argv_p){
    try {
...
void ParseCmdLine::parseCfgFile(variables_map& vm_p, const options_description& desc_p, const string& filename_p){
