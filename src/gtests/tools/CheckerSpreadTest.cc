...
TEST_F(CheckerFixture, checkSpread){
    ContextBO contextBO_l;

    buildMachine(0, 0, 0, vector<int>(), vector<int>(), &contextBO_l);
    buildMachine(1, 1, 0, vector<int>(), vector<int>(), &contextBO_l);
    buildMachine(2, 1, 0, vector<int>(), vector<int>(), &contextBO_l);
    buildMachine(3, 1, 0, vector<int>(), vector<int>(), &contextBO_l);
